          ...
          <article class="card-highlight group flex flex-col justify-between">
            <div>
              ...
              >
                <div>
                  <span
                    class="font-mono text-[10px] font-semibold uppercase tracking-wider text-primary-300"
                  >
                    01 — Angular
                  </span>
                ...
                <span
                  class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-primary-500/20 bg-primary-500/10 text-primary-300"
                  aria-hidden="true"
                >
                  ↗
                </span>
              ...
              <div class="mt-6 flex flex-wrap gap-2 border-t border-white/[0.06] pt-4">
                ...
                <span class="chip-accent">Signals</span>
            ...
            <a
              class="mt-8 inline-flex min-h-11 w-fit items-center gap-2 rounded-lg px-2 py-1 text-xs font-mono font-semibold uppercase tracking-wider text-accent-400 transition-colors hover:text-accent-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-accent-400"
          ...
          <article class="card group flex flex-col justify-between">
            <div>
              ...
              >
                <div>
                  <span
                    class="font-mono text-[10px] font-semibold uppercase tracking-wider text-accent-300"
                  >
                    02 — Angular Library
                  </span>
                  <h3 class="mt-2 text-xl font-bold tracking-tight text-white sm:text-2xl">
                ...
                <span
                  class="inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-accent-500/20 bg-accent-500/10 text-accent-300"
                  aria-hidden="true"
                >
                  ↗
                </span>
